...
public:
    ...
    void ComputeLBPFeatureVector_256_O(const Mat &srcImage, Size cellSize, Mat &featureVector);// 对ComputeLBPFeatureVector_256优化，构建滑动窗口像素查找表
    void ComputeLBPFeatureVector_256_O_2(const Mat &srcImage, Size cellSize, Mat &featureVector);// 对ComputeLBPFeatureVector_256_O的优化，主要优化掉循环中的乘法
    ...
    void ComputeLBPFeatureVector_Uniform_O(const Mat &srcImage, Size cellSize, Mat &featureVector);// 对ComputeLBPFeatureVector_Uniform优化，构建滑动窗口像素查找表
